...
measured effort can be misleading, if measured activities do not represent the
...
maintainability. Vale et al. reason that this might be because lower level
...
\todo{Loppukaneetti? Miten voi/kannattaa mitata? Vai onko edes tarve päättää
  mitään tiettyä minun tutkimukseeni, vai riittikö että kuvailin olemassaolevia
  yllä?}

\subsection{How to improve maintainability}

\todo{copy notes and fix}
